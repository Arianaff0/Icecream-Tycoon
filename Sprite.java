...
public class Sprite {
    ...
    private boolean isOnScreen; //flag for determining if the application.Sprite is on screen or not
    private static final int SCREEN_WIDTH = 1920;


    /**
     * application.Sprite Constructor
     * @param spriteName
     ...
     * @param arrivalTime
     */
//    public application.Sprite(String spriteName, Image defaultSpriteImage, Image spriteImageDest, double moneyAllowance, Point iceCreamTruck, Point position, long arrivalTime) {
...
//     * Checks to see if application.Sprite is on or off-screen, then flag is set, and we move application.Sprite to be on screen for further actions.
//     *      Further Actions:
//     *      1) Calculate the distance between destination(truck) and application.Sprite. Y coordinates not in consideration
//     *         because predefined path set to horizontal
//     *      2) Once at destination(truck), application.Sprite stops for 2 seconds, image is changed.
//     *      3) After 2 seconds, application.Sprite image changes back to original, and we increment x coordinate until application.Sprite goes off-screen.
//     */
//    public void moveSprite() {
//        if (!isOnScreen) {
//            position.setLocation(position.getX() + 1.0, 0); //the X coordinate is increased by 1 unit for application.Sprite to be on screen.
//
...
//                //if application.Sprite is at the truck we have to check how long the application.Sprite stayed there for. (Stay for 2 seconds and then leave the truck)
//                if (arrivalTime== -1) {
...
//
//    /**
//     * Method to change application.Sprite Image to the destination image.
//     */
